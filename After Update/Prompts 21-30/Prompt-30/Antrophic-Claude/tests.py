...
class TestWordsInSentence(unittest.TestCase):
    ...
    def test_no_prime_length_words(self):
        self.assertEqual(words_in_sentence("a to do it"), "to do it")
        self.assertEqual(words_in_sentence("ball tool flat"), "")
    ...
    def test_order_preservation(self):
        ...
        self.assertEqual(words_in_sentence("zebra cat dog bird"), "zebra cat dog")
    ...
    def test_boundary_cases(self):
        ...
        expected = "hi the quick fox jumps dog again and again"
